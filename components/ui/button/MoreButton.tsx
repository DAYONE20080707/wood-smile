  ...
  return (
    <Link
      ...
      className={classNames(
        "font-en tracking-[0.03em] cursor-pointer flex items-center justify-between w-[280px] md:w-[350px] px-6 py-4 relative group rounded-full font-semibold leading-[160%]",
        getVariantStyles(),
        className
      )}
    >
